...
def list_cupcakes():
    ...
    cupcakes = [cupcake.serialize_dict() for cupcake in Cupcake.query.all()]
...
def create_cupcake():
    ...
    return (jsonify(cupcake=cupcake.serialize_dict()), 201)
...
def get_cupcake(cupcake_id):
    ...
    return jsonify(cupcake=cupcake.serialize_dict())
